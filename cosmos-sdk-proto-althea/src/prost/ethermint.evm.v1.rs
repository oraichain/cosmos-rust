...
pub mod msg_client {
    ...
    use tonic::codegen::*;
    #[doc = " Msg defines the evm Msg service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " EthereumTx defines a method submitting Ethereum transactions."]
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Account queries an Ethereum account."]
        ...
        #[doc = " CosmosAccount queries an Ethereum account's Cosmos Address."]
        ...
        #[doc = " ValidatorAccount queries an Ethereum account's from a validator consensus"]
        #[doc = " Address."]
        ...
        #[doc = " Balance queries the balance of a the EVM denomination for a single"]
        #[doc = " EthAccount."]
        ...
        #[doc = " Storage queries the balance of all coins for a single account."]
        ...
        #[doc = " Code queries the balance of all coins for a single account."]
        pub async fn code(
            &mut self,
        ...
        #[doc = " Params queries the parameters of x/evm module."]
        pub async fn params(
            &mut self,
        ...
        #[doc = " EthCall implements the `eth_call` rpc api"]
        ...
        #[doc = " EstimateGas implements the `eth_estimateGas` rpc api"]
        ...
        #[doc = " TraceTx implements the `debug_traceTransaction` rpc api"]
        ...
        #[doc = " TraceBlock implements the `debug_traceBlockByNumber` and `debug_traceBlockByHash` rpc api"]
